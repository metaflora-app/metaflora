...
-- Polza requires a 100 RUB charge or batch. GPTunnel reserves must be claimed
-- individually so an unsupported funding route can be closed explicitly
-- instead of remaining queued forever.
