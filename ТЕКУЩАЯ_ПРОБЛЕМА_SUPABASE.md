# 🔴 ПРОБЛЕМА НЕ РЕШЕНА: Кеш данных в Telegram WebApp

**Дата:** 2026-01-25, 04:00  
**Статус:** ❌ getOrCreateUser() возвращает старые данные (баланс 0)  
**Проект:** Мини-апп Метафлора  
**Последний коммит:** 10d9ccb

## ⚠️ ЧИТАЙ СНАЧАЛА:
**`ТЕКУЩЕЕ_СОСТОЯНИЕ_ПРОБЛЕМЫ.md`** - там ВСЯ информация!
