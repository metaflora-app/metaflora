...
import description from '../../assets/demo-access-elements/курс на 4 урока из блоков МЕТАФЛОРА_ академия_ «система», «искусство», «промптинг» и «автоматизация».png';
...
import accessList from '../../assets/demo-access-elements/без доступа к МЕТАФЛОРА_ академия без доступа к МЕТАФЛОРА_ лаба без доступа к МЕТАФЛОРА_ цех без доступа к МЕТАФЛОРА_ полигон без доступ.png';
