/**
 * главный экран лаба (7:908)
 * Laba Main Screen - 1180x2550px
 */

import React from 'react';
import { ScreenRoot } from '../../components/layout';

export default function LabaMainScreen() {
  return (
    <ScreenRoot className="bg-[#020101] relative overflow-hidden">
      ...
      <div className="relative w-[1180px] h-[2550px] mx-auto">
        ...
        {/* Main laba interface with 4-column grid of content posts */}
        <div className="absolute top-[549px] left-[125px] w-[930px]">
          <div className="grid grid-cols-2 gap-[30px]">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="w-[450px] h-[700px] rounded-[30px] bg-gradient-to-br from-purple-900/10 to-blue-900/10 border border-white/30" />
            ))}
          </div>
        </div>
