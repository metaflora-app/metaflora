/**
 * внутри урока академии (видео) (7:1548)
 * Academy Lesson Video Screen - 1180x2550px
 * 
 * Figma→Code mapping:
 * - лучшие языковые модели. урок 1 (7:1577) → lesson title
 * - видео с обзором (7:1579) → video player (891x1457)
 * - Frame 12343457 (7:1586) → play button
 * - Frame 12343456 (7:1584) → pause button
 * - Frame 12343458 (7:1582) → fullscreen button
    ...
    <ScreenRoot className="bg-[#020101] relative overflow-hidden">
      ...
      <div className="relative w-[1180px] h-[2550px] mx-auto">
        ...
        <h1 className="absolute top-[337px] left-[94px] w-[1020px] text-white text-[80px] font-['Inter'] font-extrabold leading-[80px]">
          лучшие языковые<br />модели. урок 1
        </h1>

        {/* Video container (7:1579) */}
