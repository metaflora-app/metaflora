/**
 * о МЕТАФЛОРА* полигон (7:540)
 * About Poligon Screen - 1180x2550px
 * 
 * Figma→Code mapping:
 * - как устроена МЕТАФЛОРА* полигон (7:569) → main heading
 * - видео с обзором (7:571) → video player (891x1457)
 * - Frame 12343457 (7:577) → play button
 * - Frame 12343456 (7:574) → pause button
 * - Frame 12343458 (7:580) → fullscreen button
 * - Frame 12343458 (7:587) → CTA button with purple gradient
 */

import React from 'react';
import { ScreenRoot } from '../../components/layout';

export default function AboutPoligonScreen() {
  return (
    <ScreenRoot className="bg-[#020101] relative overflow-hidden">
      ...
      <div className="relative w-[1180px] h-[2550px] mx-auto">
        ...
        {/* Heading (7:569) */}
        <h1 className="absolute top-[337px] left-[90px] w-[1020px] text-white text-[80px] font-['Inter'] font-extrabold leading-[80px]">
          как устроена МЕТАФЛОРА* полигон
        </h1>

        {/* Progress indicator (7:586) */}
        <div className="absolute top-[911px] left-[133px] w-[38px] h-[38px] bg-white/10 backdrop-blur rounded-[30px] border border-white/30" />

        {/* Video container (7:571) */}
        <div className="absolute top-[556px] left-[150px] w-[891px] h-[1457px]">
        ...
        {/* CTA Button (7:587) */}
        <button className="absolute bottom-[526px] left-[154px] w-[892px] h-[139px] bg-black/90 backdrop-blur rounded-[62px] border border-white/30 overflow-hidden">
          {/* Purple gradient (7:588-7:591) */}
